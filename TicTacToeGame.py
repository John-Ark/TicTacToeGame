...
o_img = pg.transform.scale(y_img, (80, 100))
...
def draw_status():
    ...
    if winner is None:
        ...
        message = winner.upper() + " 's Victory!"
...
def user_click():
    ...
    if (row and collum and board[row-1][collum-1] is None):
        global XO
